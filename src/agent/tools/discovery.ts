...
export const tools: ToolDefinition<z.ZodType>[] = [
  ...
  },
  {
    ...
    parameters: SearchByCategorySchema,
  ...
  },
  {
    ...
    parameters: GetSportsMarketsSchema,
  ...
  },
  {
    ...
    parameters: GetLiveEventsSchema,
  ...
  },
  {
    ...
    parameters: GetSeriesMarketsSchema,
...
export const executors: Record<string, (args: Record<string, unknown>, ctx: AgentContext) => Promise<ToolResult>> = {
  get_categories: async (args, ctx) => getCategoriesTool(GetCategoriesSchema.parse(args), ctx),
  search_by_category: async (args, ctx) => searchByCategoryTool(SearchByCategorySchema.parse(args), ctx),
  get_trending_markets: async (args, ctx) => getTrendingMarketsTool(GetTrendingMarketsSchema.parse(args), ctx),
  get_sports_markets: async (args, ctx) => getSportsMarketsTool(GetSportsMarketsSchema.parse(args), ctx),
  get_live_events: async (args, ctx) => getLiveEventsTool(GetLiveEventsSchema.parse(args), ctx),
  get_events: async (args, ctx) => getEventsTool(GetEventsSchema.parse(args), ctx),
  get_series_markets: async (args, ctx) => getSeriesMarketsTool(GetSeriesMarketsSchema.parse(args), ctx),
  get_all_series: async (args, ctx) => getAllSeriesTool(GetAllSeriesSchema.parse(args), ctx),
  get_all_tags: async (args, ctx) => getAllTagsTool(GetAllTagsSchema.parse(args), ctx),
  get_markets_by_tag: async (args, ctx) => getMarketsByTagTool(GetMarketsByTagSchema.parse(args), ctx),
};
