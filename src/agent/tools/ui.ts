...
export const tools: ToolDefinition<z.ZodType>[] = [
  {
    ...
    parameters: OpenWalletModalSchema,
  ...
  },
  {
    ...
    parameters: OpenPortfolioSchema,
  ...
  },
  {
    ...
    parameters: OpenOrderFormSchema,
  ...
  },
  {
    ...
    parameters: RemoveWatchlistSchema,
...
export const executors: Record<string, (args: Record<string, unknown>, ctx: AgentContext) => Promise<ToolResult>> = {
  open_wallet_modal: async (args, ctx) => openWalletModalTool(OpenWalletModalSchema.parse(args), ctx),
  open_portfolio: async (args, ctx) => openPortfolioTool(OpenPortfolioSchema.parse(args), ctx),
  open_order_form: async (args, ctx) => openOrderFormTool(OpenOrderFormSchema.parse(args), ctx),
  get_watchlist: async (args, ctx) => getWatchlistTool(GetWatchlistSchema.parse(args), ctx),
  add_watchlist: async (args, ctx) => addWatchlistTool(AddWatchlistSchema.parse(args), ctx),
  remove_watchlist: async (args, ctx) => removeWatchlistTool(RemoveWatchlistSchema.parse(args), ctx),
  get_alerts: async (args, ctx) => getAlertsTool(GetAlertsSchema.parse(args), ctx),
};
