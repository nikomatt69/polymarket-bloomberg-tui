...
export const tools: ToolDefinition<z.ZodType>[] = [
  {
    ...
    parameters: NavigateToMarketSchema,
  ...
  },
  {
    ...
    parameters: RefreshMarketsSchema,
...
export const executors: Record<string, (args: Record<string, unknown>, ctx: AgentContext) => Promise<ToolResult>> = {
  navigate_to_market: async (args, ctx) => navigateToMarketTool(NavigateToMarketSchema.parse(args), ctx),
  set_timeframe: async (args, ctx) => setTimeframeTool(SetTimeframeSchema.parse(args), ctx),
  set_sort_by: async (args, ctx) => setSortByTool(SetSortBySchema.parse(args), ctx),
  refresh_markets: async (args, ctx) => refreshMarketsTool(RefreshMarketsSchema.parse(args), ctx),
};
